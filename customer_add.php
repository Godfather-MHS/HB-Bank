...
<body>
    <form class="add_customer_form" action="customer_add_action.php" method="post">
        <div class="flex-container-form_header">
            <h1 id="form_header">Please fill the following details of customer to create account. . .</h1>
        </div>
        ...
        <div class="flex-container">
            <div class=container>
                <label>Addhar Card No. (Citizenship No.):</label><br>
        ...
        <div class="flex-container">
            ...
            <div  class=container>
                <select name="branch">
                    ...
                    <option value="newyork">Deheradoon</option>
